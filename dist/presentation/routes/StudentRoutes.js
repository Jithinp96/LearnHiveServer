...
studentRoutes.post('/logout', (0, AuthMiddleware_1.default)(authService), studentController.logout);
...
studentRoutes.get('/allcourse-progress', (0, AuthMiddleware_1.default)(authService), courseController.fetchStudentCourseProgress);
